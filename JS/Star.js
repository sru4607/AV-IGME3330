class Star{
	...
	drawRect(data){
		...
		ctx.bezierCurveTo(this.x + l, this.y - l,this.x + l, this.y - l, this.x, this.y-k) //QUAD 1
		//ctx.quadraticCurveTo(this.x + l, this.y - l, this.x, this.y-k);
		ctx.moveTo(this.x, this.y-k);
		ctx.bezierCurveTo(this.x - l , this.y - l,this.x - l , this.y - l, this.x - k, this.y) //QUAD 2
		//ctx.quadraticCurveTo(this.x - l , this.y - l, this.x - k, this.y);
		ctx.moveTo(this.x - k,this.y);
		ctx.bezierCurveTo(this.x - l, this.y + l,this.x - l, this.y + l, this.x, this.y + k) //QUAD 3
		//ctx.quadraticCurveTo(this.x - l, this.y + l, this.x, this.y + k);
		ctx.moveTo(this.x,this.y + k);
		ctx.bezierCurveTo(this.x + l, this.y + l,this.x + l, this.y + l, this.x + k, this.y) //	QUAD 4
		//ctx.quadraticCurveTo(this.x + l, this.y + l, this.x + k, this.y);
		ctx.moveTo(this.x + k, this.y);
		ctx.closePath();
		//ctx.fill();
